...
export default function Footer() {
  return (
    <footer
      className="bg-[#101010] flex flex-col items-center justify-center text-center 
    pb-[5rem] md:items-start md:justify-start md:text-left md:px-[4rem] lg:px-[16.5rem]"
    >
      <div className="lg:flex lg:justify-between lg:items-center lg:w-full">
        <div className="pt-[5rem] border-t-4 border-t-[#d87d4a] mb-[5rem]">
        ...
        <div
          className="flex flex-col items-center gap-[1.6rem] text-white text-[1.3rem] font-bold 
      mb-[5rem] md:flex-row md:gap-[3.4rem] md:text-[1.5rem] lg:pt-[5rem]"
        >
      ...
      <p className="text-[1.5rem] leading-[2.5rem] font-medium text-[gray] mb-[5rem] lg:w-[54rem]">
      ...
      <div className="md:flex md:justify-between md:items-center w-full">
        <p className="text-[1.5rem] font-medium text-[gray] mb-[5rem] md:mb-0">
          Copyright 2021. All Rights Reserved
        </p>

        <div className="flex gap-[1.6rem] justify-center">
          <svg
            width="24"
            height="24"
            xmlns="http://www.w3.org/2000/svg"
            className="fill-white hover:fill-[#d87d4a] cursor-pointer"
          >
