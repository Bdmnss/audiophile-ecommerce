...
export default function Footer() {
  return (
    <footer className="flex flex-col items-center justify-center bg-[#101010] pb-[5rem] text-center md:items-start md:justify-start md:px-[4rem] md:text-left lg:px-[16.5rem]">
      ...
      <div className="w-full md:flex md:items-center md:justify-between">
        ...
        <div className="flex justify-center gap-[1.6rem]">
          <svg
            ...
            className="cursor-pointer fill-white hover:fill-[#d87d4a]"
          >
